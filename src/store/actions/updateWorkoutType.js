...
export const updateCount = (id, count, todaysId) => {
    return dispatch => {
        ...
        axios.put(`https://gym-management-sys.firebaseio.com/${userId}/${todaysId}/workouttypes/${id}/count.json`, count)
        .then(res => {
...
export const deleteWorkoutType = ( todaysId, workoutTypeId) => {
    return dispatch => {
        ...
        axios.delete(`https://gym-management-sys.firebaseio.com/${userId}/${todaysId}/workouttypes/${workoutTypeId}.json`)
        .then(res => {
            console.log(res.data)

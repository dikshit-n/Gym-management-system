...
const Auth = props => {
    ...
    let form = (
        <Auxillary>
            ...
            <TextBox showIcon={false} type="password" required minLength={4} placeholder="password" name="password"  onChange={event => change(event)} value={state.password} /><br />
            <Button type="submit" variant="contained" size="small" >Submit</Button><br />
    ...
    return (
        <form className='AuthForm' onSubmit={event => submit(event)}>
            {redirect}
